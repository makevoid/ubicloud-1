...
RSpec.describe Prog::Kubernetes::KubernetesClusterNexus do
  ...
  describe ".assemble" do
    ...
    it "creates a kubernetes cluster" do
      st = described_class.assemble(name: "k8stest", version: "v1.32", private_subnet_id: subnet.id, project_id: customer_project.id, location_id: Location::HETZNER_FSN1_ID, cp_node_count: 3, target_node_size: "standard-8", target_node_storage_size_gib: 100)
  ...
  describe "#upgrade" do
    ...
    it "picks a CP VM to upgrade and pushes UpgradeKubernetesNode prog with it" do
      expect(client).to receive(:version).and_return("Client Version: v1.32.1")
      expect(client).to receive(:version).and_return("Client Version: v1.31.3")
    ...
    it "hops to wait when all cp vms are upgraded" do
      expect(client).to receive(:version).and_return("Client Version: v1.32.1")
      expect(client).to receive(:version).and_return("Client Version: v1.32.2")
